...
public class PrescriptionRepositoryImpl implements PrescriptionRepository {
    ...
    public void save(Drug drug, Patient patient) throws SQLException {
        String query = " insert into prescription (name, quantity, is_confirmed, is_paid," +
                " patient_national_code) values (?,?,false,false,?) ";
    ...
    public void editPrescription(String oldName, Drug newDrug, Patient patient) throws SQLException {
        String query = "update prescription set name = ? , quantity = ? where patient_national_code = ? and name = ?";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
    ...
    public void changeExistMode(boolean exist ,String name) throws SQLException {
        String query = "update prescription set dose_exist = ? where name = ?";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
    ...
    public void changeConfirmMode(boolean confirm,String nationalCode) throws SQLException {
        String query = "update prescription set is_confirmed = ? where patient_national_code = ? ";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
    ...
    public void changePaymentMode(boolean pay, String nationalCode) throws SQLException {
        String query = " update prescription set is_paid = ? where patient_national_code = ? ";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
    ...
    public void addPrice(String name, long price, String nationalCode) throws SQLException {
        String query = "update prescription set price = ? where name = ?" +
                " and patient_national_code = ? and dose_exist = true ";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
    ...
    public Prescription loadBeforeConfirm(Patient patient) throws SQLException {
        String query = "select name,quantity,patient_national_code,is_confirmed from prescription" +
                " where patient_national_code = ? and is_confirmed = false ";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
    ...
    public Prescription loadAfterConfirm(Patient patient) throws SQLException {
        String query = "select name,quantity,dose_exist,price,patient_national_code,is_confirmed,is_paid" +
                " from prescription where patient_national_code = ? and" +
                " is_confirmed = true and is_paid = false ";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
        preparedStatement.setString(1, patient.getNationalCode());
        ResultSet resultSet = preparedStatement.executeQuery();
        Prescription prescription = new Prescription();
        while (resultSet.next()){
            ...
            drug.setTotalPrice();
// bug is found here because in Drug class we use lombok and did not use setter and getters

//            try {
//                drug.setTotalPrice(1);
//            } catch (Exception e) {
//                // An exception occurred, so handle it here
//                e.printStackTrace();
//            }
    ...
    public Prescription loadAll() throws SQLException {
        String query = "select * from prescription where is_confirmed=false order by id ";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
        ResultSet resultSet = preparedStatement.executeQuery();
        Prescription prescription = new Prescription();
        while (resultSet.next()){
    ...
    public void remove(Patient patient) throws SQLException {
        String query = "delete from prescription where patient_national_code = ? and is_paid = false";
        PreparedStatement preparedStatement = DBConfig.getConnection().prepareStatement(query);
        preparedStatement.setString(1,patient.getNationalCode());
        preparedStatement.executeUpdate();
        preparedStatement.close();
