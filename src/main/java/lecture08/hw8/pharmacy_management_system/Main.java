package lecture08.hw8.pharmacy_management_system;


import lecture08.hw8.pharmacy_management_system.check.Check;
...
import lecture08.hw8.pharmacy_management_system.service.impl.AdminServiceImpl;
import lecture08.hw8.pharmacy_management_system.service.impl.PatientServiceImpl;
import lecture08.hw8.pharmacy_management_system.service.impl.PrescriptionServiceImpl;
                    ...
                    if (button2 == 1) {
                        ...
                        if (prescription == null || !prescription.getConfirm()) {
                            ...
                            if (prescriptionService.save(name, quantity, patient)) {
                                ...
                                System.out.println("Your Drug's Name is Exist");
                            }
                        }else {
